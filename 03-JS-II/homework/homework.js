...
function esEntero(numero) {
 ...
 return (Math.abs(numero) == Math.floor(Math.abs(numero))) ? true : false
...
function operadoresLogicos(num1, num2, num3) {
  ...
  else if (num1 > num2 && num1 > num3 && num1 >0 && num2 >0) return "Número 1 es mayor y positivo"
...
function doWhile(numero) {
  ...
  const final=numero+0;
  do {
    numero += 5;

  }while(numero < final+40);
